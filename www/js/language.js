var MessageTranslation = function(successCallback, errorCallback) {
	...
	this.setItalian = function() {
		...
		this.menu2 = "KatoImer";
		this.menu3 = "MA.MO.T.";
		this.menu4 = "Ricerca Dealers/Officine";
		this.menu5 = "News/Eventi/Promo";
		this.menu6 = "FAQ";
		this.menu7 = "Contatti";
	...
	this.setEnglish = function() {
		...
		this.menu2 = "KatoImer";
		this.menu3 = "MA.MO.T.";
		this.menu4 = "Search Dealers/Officine";
		this.menu5 = "News/Eventi/Promo";
		this.menu6 = "FAQ";
		this.menu7 = "Contacts";
		this.menu8 = "Assistenza";
